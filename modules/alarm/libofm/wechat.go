...
const (
	...
	// 企业号corpid
	corpid = "wxb47c14ac4600ef67"
	// 企业号密钥corpsecret
	corpsecret = "vtSjrXB5iAS3Y4NVv1wRRlrw9wVgDGG4vPusVX9F5PYP0OwrPJ_nVkdk1Lp89iPn"
)
...
func Wechat_warning(touser string, agentID string, content string) error {
	// mfile := flag.String("m", "", "-m msg.txt 从配置文件读取配置发送消息")
	// touser := flag.String("t", "Thomas", "-t user 直接接收消息的用户昵称")
	// agentid := flag.Int("i", 1, "-i 0 指定agentid")
